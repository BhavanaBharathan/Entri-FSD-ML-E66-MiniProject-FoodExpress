      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <form>
          ...
          <div className="mb-3">
            ...
            <input type="Number" className="w-full border px-4 py-2 rounded"  pattern="\d{10}" required />
          </div>

          <div className="mb-3">
            <label className="block mb-1">Address</label>
            <textarea className="w-full border px-4 py-2 rounded" rows="3" required></textarea>
          </div>
