...
export default function Contact() {
  return (
    ...
    //       <img src="FoodExpress.jpg" alt="FoodExpress Logo" className="h-10 w-10 rounded-full" />
    ...
    //     <div className="space-y-4 text-gray-700">
    //       <p>
    //         <span className="font-semibold">Address:</span> Street No: 13, Ganadi Nagar, Bangalore, India
    //       </p>
    //       <p>
    //         <span className="font-semibold">Phone:</span> +91 95768 96936
    //       </p>
    //       <p>
    //         <span className="font-semibold">Email:</span> FoodExpress@gmail.com
    //       </p>
